...
| 项目           | VB                                 | VDAC                           |
| -------------- | ---------------------------------- | ------------------------------ |
| 典型作用对象   | 高速PN结相移器                     | Heater或低速相位调节器         |
| 主要作用       | 建立高速调制器电气工作条件         | 设置两臂静态相位差             |
| 是否叠加RF     | 通常是                             | 通常不是                       |
| 主要影响       | 带宽、结电容、相移效率、损耗、线性 | MZM工作点、平均光功率、ER、OMA |
| 调节速度       | 固定或缓慢配置                     | 缓慢调节、扫描或闭环           |
| 是否用于开关光 | 通常不作为主要开关光手段           | 可能用于拉到Null点             |
| 是否每通道独立 | 常见为公共或每通道配置             | 通常每个MZM通道独立            |